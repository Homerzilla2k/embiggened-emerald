...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_CURSED_BODY, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_CURSED_BODY, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_PRANKSTER, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,

...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .baseDefense   = 60,
        .baseSpeed     = 125,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 85 : 50, // 75- > 85
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_STORM_DRAIN, ABILITY_RAIN_DISH }, // POTENTIALLY ADD WIND RIDER AS HIDDEN ABILITY
        .bodyColor = BODY_COLOR_YELLOW,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_SOUNDPROOF, ABILITY_SCRAPPY },
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_FILTER, ABILITY_ROCK_HEAD, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    {
        .baseHP        = 30,
        .baseAttack    = 40, // EFFECTIVELY AROUND 120
        .baseDefense   = 55,
        .baseSpeed     = 60,
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PURE_POWER, ABILITY_NONE, ABILITY_MINDS_EYE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_POWER_SPOT, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
    #else
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_GLUTTONY, ABILITY_LIQUID_OOZE, ABILITY_UNAWARE }, // I want to put Unaware in here somewhere  
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWALOT] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_GLUTTONY, ABILITY_TOXIC_DEBRIS, ABILITY_UNAWARE }, // I want to put Unaware in here somewhere 
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SIMPLE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Numel"),
        .cryId = CRY_NUMEL,
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_OPPORTUNIST, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_VIBRAVA}),
    },
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_FLYGON}),
    },
    ...
    {
        .baseHP        = 110,
        .baseAttack    = 83, // 78 -> 83 +5
        .baseDefense   = 80, // 73 -> 80 +7
        .baseSpeed     = 60,
        .baseSpAttack  = 76,
        .baseSpDefense = 79, // 71 -> 79 +8
        .types = MON_TYPES(TYPE_WATER, TYPE_GROUND),
        .catchRate = 75,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_ADAPTABILITY, ABILITY_HYDRATION }, // LOOK AT SIMPLE AS AN OPTION AS WELL. TRY ADAPTABILITY FIRST. RR USED ESSENTIALLY WATER BUBBLE BUT I THINK I HAVE OTHER PLANS FOR THAT
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_SHELL_ARMOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_WELL_BAKED_BODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_MIMICRY, ABILITY_REGENERATOR, ABILITY_LIBERO },
    #else
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_INFILTRATOR, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BANETTE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_INFILTRATOR, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_LEVITATE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLACK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_DUSCLOPS}),
    },
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_LEVITATE, ABILITY_STICKY_HOLD },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_LEVITATE, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_TROPIUS] =
    {
        .baseHP        = 110, // 99 -> 110
        .baseAttack    = 90, // 68 -> 90
        .baseDefense   = 90, // 83 -> 90
        .baseSpeed     = 65, // 51 -> 65
        .baseSpAttack  = 88, // 72 -> 88
        .baseSpDefense = 92, // 87 -> 92
        ...
        .abilities = { ABILITY_HARVEST, ABILITY_THICK_FAT, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,

...
static const struct LevelUpMove sPoliwrathLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_MACH_PUNCH), // Circle Throw -> Mach Punch: New Move.  New move for new role.
...
static const struct LevelUpMove sMachampLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_DUAL_CHOP),
    LEVEL_UP_MOVE(37, MOVE_SUBMISSION),
    LEVEL_UP_MOVE(41, MOVE_OCTOLOCK), // NEW MOVE SLOT -> OCTOLOCK.  i THINK IT'S A COOL MOVE FOR MACHAMP, GRAPPLING STUFF WITH ITS 4 ARMS
...
static const struct LevelUpMove sTentacoolLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(38, MOVE_MORTAL_SPIN),
...
static const struct LevelUpMove sGyaradosLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(24, MOVE_CRUNCH),
    LEVEL_UP_MOVE(28, MOVE_ICE_FANG), // REMOVE RAIN DANCE -> ICE FANG: MOVE ICE FANG DOWN. GET RID OF RAIN DANCE TO CANCEL FLANNERY
...
static const struct LevelUpMove sXatuLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(42, MOVE_COSMIC_POWER), // NEW MOVE SLOT -> COSMIC POWER
...
static const struct LevelUpMove sAzumarillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(46, MOVE_BELLY_DRUM), // DOUBLE EDGE -> BELLY DRUM: EGG MOVE. LATE GAME BD AJ ACTION
    LEVEL_UP_MOVE(49, MOVE_JET_PUNCH), // New Move Slot -> Jet Punch
...
static const struct LevelUpMove sMagcargoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_LAVA_PLUME),
    LEVEL_UP_MOVE(36, MOVE_AMNESIA),
    LEVEL_UP_MOVE(40, MOVE_BURNING_BULWARK), // NEW MOVE SLOT -> BURNING_BULWARK: NEW MOVE. PROTECT AND BURN UTILITY.
...
static const struct LevelUpMove sDonphanLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(46, MOVE_EARTHQUAKE),
	LEVEL_UP_MOVE(51, MOVE_COMBAT_TORQUE), // Giga Impact -> Close Combat: New Fighting Type Move - Great Tusk Move
...
static const struct LevelUpMove sBeautiflyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_POISON_STING),
    LEVEL_UP_MOVE( 1, MOVE_BUG_BITE),
    LEVEL_UP_MOVE(13, MOVE_STRUGGLE_BUG), // ABSORB -> STRUGGLE BUG: TM MOVE: BUG STAB
...
static const struct LevelUpMove sCascoonLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE(11, MOVE_TOXIC_THREAD),
    LEVEL_UP_MOVE(13, MOVE_STICKY_WEB),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sDustoxLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_POISON_STING),
    LEVEL_UP_MOVE( 1, MOVE_BUG_BITE),
    LEVEL_UP_MOVE(13, MOVE_STRUGGLE_BUG), // CONFUSION -> STRUGGLE BUG: TM MOVE. BUG STAB.
    LEVEL_UP_MOVE(15, MOVE_POISON_POWDER),
...
static const struct LevelUpMove sSwellowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(33, MOVE_AIR_SLASH), // SWITCH AIR SLASH AND DWB
    LEVEL_UP_MOVE(37, MOVE_DUAL_WINGBEAT), // AGILITY -> DUAL WING BEAT. TUTOR MOVE: THIS THING IS ALREADY AT 125 BASE SPEED, DOES IT REALLY NEED AGILITY?
	...
	LEVEL_UP_MOVE(58, MOVE_BOOMBURST), // NEW MOVE SLOT -> BOOMBURST. EGG MOVE: 
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSurskitLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_AQUA_JET), // NEW MOVE SLOT -> MOVE AQUA JET UP FROM 30
    LEVEL_UP_MOVE(13, MOVE_STRUGGLE_BUG), //WATER SPORT -> STRUGGLE BUG. TM MOVE: BUG STAB
    LEVEL_UP_MOVE(16, MOVE_BUBBLE_BEAM),
    LEVEL_UP_MOVE(20, MOVE_SYRUP_BOMB), // NEW MOVE SLOT -> SYRUP BOMB: NEW MOVE. FITS THE WITH SYRUP FROM ITS HEAD. MIGHT MOVE IT TO AFTER EVOLUTION
    LEVEL_UP_MOVE(22, MOVE_AGILITY),
    LEVEL_UP_MOVE(25, MOVE_MIST),
    LEVEL_UP_MOVE(28, MOVE_STICKY_WEB),
    LEVEL_UP_MOVE(30, MOVE_LIQUIDATION), // AQUA JET -> LIQUIDATION: NEW MOVE. SAME KIND OF VIBE AS AQUAJET
    LEVEL_UP_MOVE(35, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(38, MOVE_BUG_BUZZ),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMasquerainLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 3, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 6, MOVE_SWEET_SCENT),
	LEVEL_UP_MOVE( 9, MOVE_STRUGGLE_BUG), // NEW MOVE -> STRUGGLE BUG. TM MOVE: BUG STAB
    LEVEL_UP_MOVE(12, MOVE_AQUA_JET),
    LEVEL_UP_MOVE(14, MOVE_WATER_SPORT),
    LEVEL_UP_MOVE(17, MOVE_BUBBLE_BEAM), // GUST -> BUBBLE BEAM. PRE-EVO MOVE: IT MAKES IT MORE INTERESTING IF IT STILL LEANRS WATER MOVES.
    LEVEL_UP_MOVE(22, MOVE_SCARY_FACE),
    LEVEL_UP_MOVE(22, MOVE_AIR_CUTTER),
    LEVEL_UP_MOVE(26, MOVE_GLARE), // STUN SPORE -> GLARE. NEW MOVE: USES THE WING FACE TO PARALYZE. 
	LEVEL_UP_MOVE(29, MOVE_SILVER_WIND),
    LEVEL_UP_MOVE(32, MOVE_STICKY_WEB), // NEW MOVE SLOT -> STICKY WEB. PRE-EVO MOVE. STICKY WEB IS TOO GOOD
	LEVEL_UP_MOVE(35, MOVE_AIR_SLASH),
    LEVEL_UP_MOVE(38, MOVE_BUG_BUZZ),
    LEVEL_UP_MOVE(42, MOVE_BATON_PASS), // NEW MOVE SLOT -> BATON PASS. PRE-EVO MOVE.
...
static const struct LevelUpMove sBreloomLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(41, MOVE_SPORE), // Seed Bomb -> Spore
    LEVEL_UP_MOVE(46, MOVE_DYNAMIC_PUNCH),
    LEVEL_UP_MOVE(51, MOVE_FOCUS_PUNCH),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSlakothLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(12, MOVE_ROCK_SMASH), // New Move Slot -> Rock Smash: Old TM Move. Make it an interesting option for Roxanne.
...
static const struct LevelUpMove sNincadaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_POUNCE), // FALSE SWIPE -> POUNCE. TM MOVE: FALSE SWIPE IS AN EARLY GAME TM. THIS GIVES GOOD EARLY BUG COVERAGE ESPECIALLLY FOR CRADILLY.
    LEVEL_UP_MOVE(13, MOVE_MUD_SLAP),
	LEVEL_UP_MOVE(16, MOVE_HONE_CLAWS), // NEW MOVE SLOT -> HONE CLAWS. TM MOVE: FITS.
    LEVEL_UP_MOVE(22, MOVE_DIG), // ABSORB -> DIG: MOVE DIG UP. REWARD FOR HOLDING OUT ON EVOLVING
    LEVEL_UP_MOVE(25, MOVE_METAL_CLAW),
    LEVEL_UP_MOVE(30, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(35, MOVE_LEECH_LIFE), // MIND READER -> LEECH LIFE: OLD MOVE. NINJASK GETS IT
...
static const struct LevelUpMove sNinjaskLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(13, MOVE_HONE_CLAWS), // MUD-SLAP -> HONE CLAWS: TM MOVE. GIVE IT SOMETHING FUN TO BATON PASS BEFORE SWORDS DANCE. 
    LEVEL_UP_MOVE(15, MOVE_AGILITY),
    LEVEL_UP_MOVE(23, MOVE_METAL_CLAW), // ABSORB -> METAL CLAW
    LEVEL_UP_MOVE(27, MOVE_BUG_BITE),
	LEVEL_UP_MOVE(31, MOVE_BATON_PASS),
    LEVEL_UP_MOVE(35, MOVE_SLASH), // FURY SWIPES -> SLASH: MOVE SLASH UP
    LEVEL_UP_MOVE(39, MOVE_LEECH_LIFE), // MIND READER -> LEECH LIFE: TM/OLD MOVE. BUG POWER UP
    LEVEL_UP_MOVE(43, MOVE_SWORDS_DANCE), // MOVE SWORDS DANCE TO OLD SLASH SPOT
    LEVEL_UP_MOVE(47, MOVE_DUAL_WINGBEAT), // SWORDS DANCE -> DUAL WING BEAT: NEW MOVE. FLYING STAB
    LEVEL_UP_MOVE(51, MOVE_FIRST_IMPRESSION), // X-SCISSOR -> FIRST IMPRESSION: NEW MOVE. BUG STAB THAT I THINK FITS WELL.
    LEVEL_UP_END
};
...
static const struct LevelUpMove sShedinjaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(31, MOVE_SPITE), // FURY SWIPES -> SPITE
    LEVEL_UP_MOVE(35, MOVE_X_SCISSOR), // MIND READER ->  X-SCISSOR: REST OF THE LINE MOVE. SOME BUG STAB.
    LEVEL_UP_MOVE(39, MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(43, MOVE_MEMENTO), // SPITE -> MEMENTO: NEW MOVE. SOMETHING TO DO WHEN YOU THINK YOU'LL LOSE SHEINJA. AND I THINK IT FITS THE THEME.
    LEVEL_UP_MOVE(47, MOVE_PHANTOM_FORCE),
	LEVEL_UP_MOVE(51, MOVE_FIRST_IMPRESSION), // NEW MOVE SLOT -> FIRST IMPRESSION: NEW MOVE. BUG STAB THAT I THINK FITS WELL
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSkittyLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(15, MOVE_ASSIST), // ATTRACT -> ASSIST: MOVE FROM 16 -> 15.  ASSIST ACCESS FOR ROXANNE
    LEVEL_UP_MOVE(17, MOVE_ATTRACT), // ATTRACT -> COPYCAT: SWITCH MOVES
    LEVEL_UP_MOVE(20, MOVE_COPYCAT), // NEW MOVE SLOT -> ENCORE
    LEVEL_UP_MOVE(22, MOVE_ENCORE), // Payback -> Assist -> COPYCAT: END OF MOVE JUGGLING
    LEVEL_UP_MOVE(25, MOVE_MILK_DRINK), // CHARM -> MILK DRINK: ITS A CAT
	LEVEL_UP_MOVE(28, MOVE_FACADE),
    LEVEL_UP_MOVE(31, MOVE_ENTRAINMENT), // FACADE -> ENTRAINMENT: NEW MOVE. ENTRAINMENT NORMALIZE COULD BE FUN
...
static const struct LevelUpMove sDelcattyLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_COSMIC_POWER), // NEW EVOLUTION MOVE -> COSMIC POWER: EGG MOVE.  FITS THE SPACE THEME.
    LEVEL_UP_MOVE( 1, MOVE_COSMIC_POWER),
    LEVEL_UP_MOVE( 1, MOVE_FAKE_OUT),
    LEVEL_UP_MOVE( 1, MOVE_CHARM), // GROWL -> CHARM: MOVE CHARM UP. FITS CHARACTER BETTER
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 4, MOVE_SWIFT), // TACKLE -> SWIFT: NEW MOVE. XENMODE IDEA
    LEVEL_UP_MOVE( 7, MOVE_HELPING_HAND),
    LEVEL_UP_MOVE(10, MOVE_YAWN), // SING -> YAWN: EGG MOVE. ZENMODE IDEA
    LEVEL_UP_MOVE(13, MOVE_DISARMING_VOICE),
    LEVEL_UP_MOVE(15, MOVE_ASSIST), // ATTRACT -> ASSIST: MOVE FROM 16 -> 15.  ASSIST ACCESS FOR ROXANNE
...
static const struct LevelUpMove sSableyeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(49, MOVE_BADDY_BAD), // FOUL PLAY -> BADDY BAD: NEW MOVE.  I THINK IT FITS REALLY WELL, OR THE IDEA OF IT CHANNELING EVIL ENGERY THROUGH ITS GEM TO DEAL DAMAGE AND SET UP A WALL DOES
    LEVEL_UP_MOVE(53, MOVE_DIAMOND_STORM), // NEW MOVE SLOT -> DIAMOND STORM: NEW MOVE. AGAIN, IT FITS.
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMawileLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(48, MOVE_GIGATON_HAMMER), // PLAY ROUGH -> GIGATON HAMMER: NEW MOVE. NOT SURE IF I LOVE THIS, BUT IT'S SOMETHING TO THINK ABOUT AS A COOL MOVE FOR MAWILE.  WOULD MAKE IT BITE THEMED.
    LEVEL_UP_END
};
...
static const struct LevelUpMove sGulpinLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_ACID_SPRAY), // SLUDGE -> ACID SPRAY: ACID SPRAY LOWERS SP DEF. BETWEEN ACID SPRAY AND SYRUP BOMB GULPIN COULD DO SOME VERY HIGH EARLY GAME STAT REDUCTION.
    LEVEL_UP_MOVE(12, MOVE_AMNESIA),
    LEVEL_UP_MOVE(17, MOVE_SYRUP_BOMB), // ACID SPRAY -> SYRUP BOMB. NEW MOVE: SAME KIND OF VISUAL EFFECT, BUT LOWERS SPEED FOR 3 TURNS. ALSO, NO STAB SO ABOUT THE SAME POWER AS ACID SPRAY.
	...
	LEVEL_UP_MOVE(30, MOVE_TIDY_UP), // NEW MOVE SLOT -> TIDY UP. NEW MOVE: THINK OF IT AS SWALOT/GULPIN GOING FULL KIRBY AND INHALING EVERYTHING ON THE FIELD.
    LEVEL_UP_MOVE(33, MOVE_SLUDGE_BOMB),
    LEVEL_UP_MOVE(36, MOVE_GASTRO_ACID),
...
static const struct LevelUpMove sSwalotLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(33, MOVE_TIDY_UP), // NEW MOVE SLOT -> TIDY UP. NEW MOVE: THINK OF IT AS SWALOT/GULPIN GOING FULL KIRBY AND INHALING EVERYTHING ON THE FIELD.
    LEVEL_UP_MOVE(37, MOVE_SLUDGE_BOMB),
	LEVEL_UP_MOVE(40, MOVE_SLACK_OFF), // NEW MOVE SLOT -> SLACK OFF. NEW MOVE: RECOVERY. YAY! IF YOU WANT TO MAKE IT THEMATIC THINK OF IT AS BEING FULL
...
static const struct LevelUpMove sNumelLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(22, MOVE_YAWN), // LAVA PLUME -> YAWN: MOVE YAWN FROM 36. LAVA PLUME AT 22 TOO MUCH.
    LEVEL_UP_MOVE(26, MOVE_CURSE), // EARTH POWER -> SCORCHING SAND: EP AT 26 TOO STRONG.  SS AT 26 IS BETWEEN SCALD ON MONKEY AND VOLCANION
    LEVEL_UP_MOVE(29, MOVE_SCORCHING_SANDS), // CURSE -> SCORCHING SAND: SS WITH SHEER FORCE AT LEVEL 26 IS A LOT.  29 IS SLIGHTLY BETTER.
    LEVEL_UP_MOVE(31, MOVE_LAVA_PLUME), // TAKE DOWN -> LAVA PLUME: LAVA PLUME POWER UPRADE
    LEVEL_UP_MOVE(36, MOVE_TAKE_DOWN), // YAWN -> TAKE DOWN: MOVE TAKE DOWN TO YAWNS OLD SPOT
    LEVEL_UP_MOVE(40, MOVE_EARTH_POWER), // EARTHQUAKE -> EARTH POWER: MOVE EARHT POWER TO EQS SPOT.  
    LEVEL_UP_MOVE(43, MOVE_FLAMETHROWER),
    LEVEL_UP_MOVE(47, MOVE_DOUBLE_EDGE),
    LEVEL_UP_END
};
static const struct LevelUpMove sCameruptLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_ROCK_SLIDE), // Evolves at 33.
    LEVEL_UP_MOVE( 1, MOVE_ROCK_SLIDE),
    LEVEL_UP_MOVE( 1, MOVE_GROWL),
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
    LEVEL_UP_MOVE( 5, MOVE_EMBER),
    ...
    LEVEL_UP_MOVE(29, MOVE_SCORCHING_SANDS), // CURSE -> SCORCHING SAND: SS WITH SHEER FORCE AT LEVEL 26 IS A LOT.  29 IS SLIGHTLY BETTER.
    LEVEL_UP_MOVE(31, MOVE_LAVA_PLUME), // TAKE DOWN -> LAVA PLUME: LAVA PLUME POWER UPRADE 
    LEVEL_UP_MOVE(39, MOVE_TAKE_DOWN), // YAWN -> TAKE DOWN: MOVE TAKE DOWN TO YAWNS OLD SPOT
    LEVEL_UP_MOVE(46, MOVE_EARTH_POWER), // EARTHQUAKE -> EARTH POWER: MOVE EARTH POWER TO EQS SPOT.  
...
static const struct LevelUpMove sSpoinkLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(10, MOVE_ENCORE), // GROWL -> ENCORE: TM MOVE. FITS SPOINT FOR CLAPPING AND GRUMPIG FOR CONTROL.
...
static const struct LevelUpMove sGrumpigLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_TEETER_DANCE),
	LEVEL_UP_MOVE( 1, MOVE_BOUNCE), // SPLASH -> BOUNCE: MOVE BOUNCE FROM 50 TO GIVE E4 ACCESS TO QUIVER DANCE.
    LEVEL_UP_MOVE( 4, MOVE_CONFUSION),
    LEVEL_UP_MOVE( 7, MOVE_GROWL),
    LEVEL_UP_MOVE(10, MOVE_ENCORE),
	LEVEL_UP_MOVE(13, MOVE_PSYBEAM),
	...
	LEVEL_UP_MOVE(51, MOVE_QUIVER_DANCE), // NEW MOVE SLOT -> QUIVER DANCE: NEW MOVE. NEW BIG BUFF MOVE. MIGHT MOVE UP IN LEARNSET TO HAVE FOR THE E4.
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSpindaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(23, MOVE_DOUBLE_TEAM), // BODY SLAM -> DOUBLE TEAM: NEW MOVE. FOR THE STAGGERING EVASIVENESS
    LEVEL_UP_MOVE(26, MOVE_DIZZY_PUNCH), // NEW MOVE SLOT -> DIZZY PUNCH: OL MOVE. READD DIZZY PUNCH
    LEVEL_UP_MOVE(29, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(33, MOVE_BODY_SLAM), // NEW MOVE SLOT -> BODY SLAM: MOVE BODY SLAM TO LEVEL 33
    LEVEL_UP_MOVE(37, MOVE_UPROAR),
    LEVEL_UP_MOVE(40, MOVE_PSYCH_UP),
    LEVEL_UP_MOVE(43, MOVE_SUPERPOWER), // NEW MOVE SLOT -> SUPERPOWER: NEW MOVE. CONTRARY SHENANIGANS
...
static const struct LevelUpMove sSwabluLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 3, MOVE_ASTONISH),
    LEVEL_UP_MOVE( 5, MOVE_SING),
    LEVEL_UP_MOVE( 7, MOVE_DISARMING_VOICE), // FURY ATTACK -> DISARMING VOICE: MOVE DISARMING VOICE UP.
    LEVEL_UP_MOVE( 9, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(11, MOVE_MIST), // MIST MOVES TO DISARMING VOICE'S SPOT
    LEVEL_UP_MOVE(14, MOVE_ROUND), // ROUND MOVES TO MIST'S SPOT
    LEVEL_UP_MOVE(17, MOVE_PLUCK), // ROUND -> PLUCK: TM MOVE. FLYING TYPE POWER INCREASE
...
static const struct LevelUpMove sSeviperLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 6, MOVE_LICK),
    LEVEL_UP_MOVE( 9, MOVE_POISON_STING), // Poison Tail -> Poison Sting: Poison Tail is moving to a later level because its much better.  Early Poison STAB
    ...
    LEVEL_UP_MOVE(31, MOVE_POISON_TAIL), // Poison Jab -> Poison Tail.  Get its second signature move there instead of Poison Jab
...
#endif //P_FAMILY_LUNATONE // ADD GLITZY GLOW
...
#endif //P_FAMILY_SOLROCK // ADD GLITZY GLOW
...
static const struct LevelUpMove sWhiscashLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(34, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE(38, MOVE_MUDDY_WATER),
	LEVEL_UP_MOVE(41, MOVE_SPIKES), // NEW MOVE SLOT -> SPIKES: TM MOVE. NATURAL SPIKE SETTER FOR MORE UTLITY
	LEVEL_UP_MOVE(44, MOVE_DRAGON_DANCE), // NEW MOVE SLOT -> DRAGON DANCE: EGG/TM MOVE. GIVE IT A WAY TO BOOST.
...
static const struct LevelUpMove sClaydolLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE(40, MOVE_SHORE_UP), //NEW MOVE SLOT -> SHORE UP. NEW MOVE: USING THE SAND TO ADD TO IT'S BODY. RECOVERY IT SORELY NEEDS.
    LEVEL_UP_MOVE(43, MOVE_SANDSTORM),
	LEVEL_UP_MOVE(46, MOVE_BODY_PRESS), // NEW MOVE SLOT -> BODY PRESS. TM MOVE: USES IT'S DEFENSE TO ATTACK.  MIGHT MOVE TO LEVEL 1 OR SOMETHING.
    LEVEL_UP_MOVE(50, MOVE_EXPLOSION), // MOVED FROM 48 -> 50 TO MAKE ROOM FOR BODY PRESS SLOT. MIGHT CHANGE
    LEVEL_UP_END
};
...
static const struct LevelUpMove sKecleonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_DISABLE), // New Move Slot -> Disable: Move Disable up
    LEVEL_UP_MOVE( 1, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE( 1, MOVE_LICK), // Scratch -> ????
    LEVEL_UP_MOVE( 4, MOVE_CONSTRICT), // Bind -> Constrict: Better Bind/Scratch combo.
    LEVEL_UP_MOVE( 7, MOVE_SHADOW_SNEAK),
    LEVEL_UP_MOVE(10, MOVE_FEINT),
    LEVEL_UP_MOVE(13, MOVE_GRASSY_GLIDE), // Fury Swipes -> Grassy Glide: GG for Terrain stuff
    LEVEL_UP_MOVE(16, MOVE_FEINT_ATTACK), // Disable -> Feint Attack: Add FA back in
    LEVEL_UP_MOVE(18, MOVE_PSYBEAM),
    LEVEL_UP_MOVE(21, MOVE_ANCIENT_POWER),
    LEVEL_UP_MOVE(25, MOVE_NATURE_POWER), // SLASH -> NATURE POWER
    LEVEL_UP_MOVE(29, MOVE_DETECT),
    LEVEL_UP_MOVE(33, MOVE_SHADOW_CLAW),
    LEVEL_UP_MOVE(37, MOVE_TERRAIN_PULSE), // SCHREECH -> TERRAIN PULSE
    LEVEL_UP_MOVE(40, MOVE_CONVERSION_2), // New Move Slot -> Conversion 2: What I wanted Color Change to be
    LEVEL_UP_MOVE(43, MOVE_SHED_TAIL), // SUBSTITUTE-> SHED TAIL
    LEVEL_UP_MOVE(46, MOVE_SUCKER_PUNCH),
    LEVEL_UP_MOVE(50, MOVE_FOUL_PLAY),
    LEVEL_UP_MOVE(54, MOVE_EXPANDING_FORCE), // Synchronize -> Expanding Force
    LEVEL_UP_MOVE(57, MOVE_WRING_OUT), // New Move Slot -> Wring Out
    LEVEL_UP_END
};
...
static const struct LevelUpMove sChinglingLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(16, MOVE_ENTRAINMENT),  // Move Entrainment to 16. Replaces Stored Power on Chimecho.
    LEVEL_UP_MOVE(19, MOVE_ECHOED_VOICE), 
    LEVEL_UP_MOVE(22, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE(25, MOVE_FOLLOW_ME), // New Move Slot -> Follow Me: New Move.  Replaces Ally Switch on Chimecho.  Either need to use Chingling until 25 or pay Heart Scale to get FM on Chimecho.
    LEVEL_UP_MOVE(28, MOVE_UPROAR),
    LEVEL_UP_MOVE(31, MOVE_HEAL_BELL),
    LEVEL_UP_MOVE(35, MOVE_PSYCHIC_NOISE),
    LEVEL_UP_MOVE(39, MOVE_SAFEGUARD),
    LEVEL_UP_MOVE(41, MOVE_PSYSHOCK), // New Move Slot -> Psyshock: New Move. Chingling version of Expanding Force
    LEVEL_UP_MOVE(43, MOVE_LAST_RESORT), // Move Last Resort to Clangorous Soul spot in Chimecho's moveset.
    LEVEL_UP_MOVE(47, MOVE_HYPER_VOICE),
    LEVEL_UP_END // Added several moves to match Chimecho.
};
#endif //P_GEN_4_CROSS_EVOS
...
static const struct LevelUpMove sChimechoLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(19, MOVE_ECHOED_VOICE), // Take Down -> Echoed Voice: New Move. Fits dex lore really well
    LEVEL_UP_MOVE(22, MOVE_EXTRASENSORY),
    ...
    LEVEL_UP_MOVE(51, MOVE_CLANGOROUS_SOUL), // New Move Slot -> Clangorous Soul: New Move. Fun move and this Pokemon fits best.  Plus, it's Chimecho. Let it be fun broken.
    LEVEL_UP_MOVE(54, MOVE_EXPANDING_FORCE), // New Move Slot -> Expanding Force
    LEVEL_UP_END
};

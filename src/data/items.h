...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = (I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 1500 : 1500),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),

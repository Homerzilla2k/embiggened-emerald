...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_ACID] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
            .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = B_UPDATED_MOVE_DATA >= GEN_4 ? MOVE_EFFECT_BURN : MOVE_EFFECT_DEF_MINUS_1,
            .chance = 30,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
    ...
    [MOVE_WATER_SPORT] =
    {
        .name = COMPOUND_STRING("Ripple Rush"),
        .description = COMPOUND_STRING(
            "The user attacks with the\n"
            "force of a small wave."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_MOUNTAIN_GALE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Giant ice chunks hit the foe\n"
            "May flinch or frostbite."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ICE,
        .accuracy = 85,
    ...
    {
        .name = COMPOUND_STRING("Chilling Reception"),

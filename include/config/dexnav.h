...
// Flag/var defines
#define DN_FLAG_SEARCHING             SYSTEM_FLAGS + 0x86// Searching for mon
#define DN_FLAG_DEXNAV_GET            SYSTEM_FLAGS + 0x85 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         SYSTEM_FLAGS + 0x87 // Allow player to find hidden mons
